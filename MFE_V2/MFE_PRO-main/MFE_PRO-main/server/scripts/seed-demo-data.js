...
const mysql2_1 = __importDefault(require("mysql2/promise"));
require("dotenv").config({ path: require("path").resolve(__dirname, "../.env") });
const db_1 = { default: mysql2_1.default.createPool({
