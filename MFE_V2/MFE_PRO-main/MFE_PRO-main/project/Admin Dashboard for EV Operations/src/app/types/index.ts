...
export interface Station {
  ...
  city: string;
  address: string;
  connectorType: ConnectorType; // dominant type (highest power) — kept for backward compat
  power: number; // max power across connectors — kept for backward compat
...
export interface KPIData {
  ...
  maintenanceStationsTrend: number;
  uptimeRateTrend: number;
}
