...
const NotificationsRoute  = withRoles(Notifications, ['super_admin', 'tenant_admin']);
...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      { path: 'dashboard', Component: AdminOnly },
      { path: 'stations',  Component: StationsRoute },
      ...
      { path: 'my-tasks',       Component: MyTasksRoute },
