...
const PULSING_STATUSES = new Set(['charging', 'active']);

export function StatusChip({ status, type: _type }: StatusChipProps) {
  ...
  return (
    <Badge variant="secondary" className={`${config.className} font-medium inline-flex items-center gap-1.5`}>
      {isPulsing && (
