...
export function Header({ onMenuClick }: HeaderProps) {
  ...
  const roleBadge = useMemo(() => {
    ...
    return roleLabels[currentUser?.role ?? 'technician'] ?? 'Technician';
  }, [currentUser?.role]);
          ...
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" className="gap-2 px-2 md:px-3">
              ...
              <div className="hidden text-left md:block">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">{roleBadge}</p>
              </div>
          ...
          <DropdownMenuContent align="end" className="w-56">
            <DropdownMenuItem disabled>
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">{roleBadge}</p>
              </div>
            </DropdownMenuItem>
            <DropdownMenuSeparator />
